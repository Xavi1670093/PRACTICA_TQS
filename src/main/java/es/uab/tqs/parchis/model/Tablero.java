...
public class Tablero {
    ...
    public void mostrar() {
        // Aquí tendrías un arreglo 19x19 con los números de cada casilla del tablero
        int[][] numerosTablero = new int[19][19];

        // Inicializas los números según tu recorrido
        ...
        numerosTablero[2][8] = 36;
        numerosTablero[3][8] = 36;
        numerosTablero[4][8] = 36;
        numerosTablero[5][8] = 36;
        numerosTablero[6][8] = 36;
        ...
        // El resto de casillas puedes llenarlas según tu lógica del tablero
